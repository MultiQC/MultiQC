...
- Fix Kraken incorrectly assigning ranks to tabs (https://github.com/ewels/MultiQC/issues/1766). Add support for `R1` rank ("Superdomain" which includes non-cellular organisms like viruses).

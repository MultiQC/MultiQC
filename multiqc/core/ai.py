...
class LLMClient:
    ...
    def chat(self, message: List[str]) -> str:
...
Be specific: it's okay to just say that the data is good, if no items stand out as problematic.

Please use HTML formatting to make the summary visually attractive. Use colors to bring user's attention \
to really important pieces, but do not make them very bright.

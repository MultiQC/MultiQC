...
class MultiqcModule(BaseMultiqcModule):
    """
    The Bamtools module parses `bamtools stats` logs generated by Bamtools.
    ...
    def __init__(self):
        ...
        super(MultiqcModule, self).__init__(
            ...
            info="Bamtools provides both a programmer's API and an end-user's toolkit for handling BAM files.",

...
class MultiqcModule(BaseMultiqcModule):
    """
    BioBloom Tools (BBT) provide the means to create filters for a given reference and then to categorize sequences.
    ...
    def __init__(self):
        ...
        super(MultiqcModule, self).__init__(
            ...
            info="BioBloom Tools assigns reads to different references using bloom filters. This is faster than alignment and can be used for contamination detection.",

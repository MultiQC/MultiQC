...
class MultiqcModule(BaseMultiqcModule):
    ...
    so it is impossible to distiguish which tool was used.
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(
            ...
            info="Results from both Bowtie 2 and HISAT2, fast and memory-efficient tools for aligning sequencing "

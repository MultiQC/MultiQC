...
class MultiqcModule(BaseMultiqcModule):
    ...
    def filter_and_pass(self, data):
        ...
        for entry in attributes:
            if entry["id"].startswith("filtered") or entry["id"] == "zmw_passed_yield" or entry["id"].startswith("ccs_processing.filtered") or entry["id"] == "ccs_processing.zmw_passed_yield":

...
class MultiqcModule(BaseMultiqcModule, CellRangerCountMixin, CellRangerVdjMixin):
    """
    The Cell Ranger module parses the quality reports generated by Cell Ranger (tested on Cell Ranger 6) and
    summarise the main information useful for QC, including:

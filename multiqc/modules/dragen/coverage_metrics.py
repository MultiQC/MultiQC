...
COV_METRICS = list(itertools.chain.from_iterable([[
    Metric(m.id, m.title, in_genstats=m.in_genstats, in_own_tabl=m.in_own_tabl,
           unit=m.unit, descr=m.descr, namespace=NAMESPACE, precision=m.precision),
    Metric(m.id.replace('{}', 'genome'), m.title.replace('{}', 'genome'), in_genstats=m.in_genstats, in_own_tabl=m.in_own_tabl,
           unit=m.unit, descr=m.descr.replace('{}', 'genome'), namespace=NAMESPACE, precision=m.precision),
    Metric(m.id.replace('{}', 'genome'), m.title.replace('{}', 'region'), in_genstats=m.in_genstats, in_own_tabl=m.in_own_tabl,
           unit=m.unit, descr=m.descr.replace('{}', 'region'), namespace=NAMESPACE, precision=m.precision),
] for m in [
    ...
    Metric('Aligned reads in region', 'Reads on trg', 'hid', '%', 'reads',
    ...
    Metric('Aligned bases in region', 'Bases on trg', 'hid', '%', 'bases',
    ...
    Metric('Average autosomal coverage over {}', 'Mean aut cov', None, 'hid', 'x',
    ...
    Metric('Mean/Median autosomal coverage ratio over {}', 'Mean/med aut cov', 'hid', '#', '',
           'Mean autosomal coverage in {} divided by the median autosomal coverage in {}. If there is no autosome in the reference genome or the region does not intersect autosomes, this metric shows as NA.', precision=2),
    Metric('PCT of genome with coverage [  1x: inf)', '⩾1x', 'hid', '#',
           '%', 'Percentage of sites in region with at least 1x coverage.'),
    Metric('PCT of genome with coverage [  3x: inf)', '⩾3x', None, 'hid',
           '%', 'Percentage of sites in region with at least 3x coverage.'),
    Metric('PCT of genome with coverage [ 10x: inf)', '⩾10x', None, '#',
           '%', 'Percentage of sites in region with at least 10x coverage.'),
    Metric('PCT of genome with coverage [ 15x: inf)', '⩾15x', None, 'hid',
           '%', 'Percentage of sites in region with at least 15x coverage.'),
    Metric('PCT of genome with coverage [ 20x: inf)', '⩾20x', '#', '#', '%',
           'Percentage of sites in region with at least 20x coverage.'),
    Metric('PCT of genome with coverage [ 50x: inf)', '⩾50x', 'hid', '#',
           '%', 'Percentage of sites in region with at least 50x coverage.'),
    Metric('PCT of genome with coverage [100x: inf)', '⩾100x', 'hid', '#',
           '%', 'Percentage of sites in region with at least 100x coverage.'),
    Metric('PCT of genome with coverage [  0x:  1x)', '0x', None, 'hid',
           '%', 'Percentage of sites in region with no coverage.'),
    Metric('PCT of genome with coverage [  1x:  3x)', '1x..3x', None, 'hid', '%',
           'Percentage of sites in region with at least 1x but less than 3x coverage.'),
    Metric('PCT of genome with coverage [  3x: 10x)', '3x..10x', None, 'hid', '%',
           'Percentage of sites in region with at least 3x but less than 10x coverage.'),
    Metric('PCT of genome with coverage [ 10x: 15x)', '10x..15x', None, 'hid', '%',
           'Percentage of sites in region with at least 10x but less than 15x coverage.'),
    Metric('PCT of genome with coverage [ 15x: 20x)', '15x..20x', None, 'hid', '%',
           'Percentage of sites in region with at least 15x but less than 20x coverage.'),
    Metric('PCT of genome with coverage [ 20x: 50x)', '20x..50x', 'hid', 'hid', '%',
           'Percentage of sites in region with at least 20x but less than 50x coverage.'),
    Metric('PCT of genome with coverage [ 50x:100x)', '50x..100x', 'hid', 'hid', '%',

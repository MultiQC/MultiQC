...
COV_METRICS = list(itertools.chain.from_iterable([[
    ...
    Metric('Average mitochondrial coverage over {}'         , 'MT cov'          , None , 'hid', 'x'    , 'Average mitochondrial chromosome coverage over {}. Calculated as the number of bases that aligned to the mitochondrial chromosome (or to the intersection of mitochondrial chromosome with the target region) divided by the total number of loci in the mitochondrial chromosome (or the intersection with the target region). If there is no mitochondrial chromosome in the reference genome or the region does not intersect mitochondrial chromosome, this metric shows as NA.'),
    Metric('Average autosomal coverage over {}'             , 'Avg aut cov'     , None , 'hid', 'x'    , 'Average autosomal coverage over {}. Calculated as the number of bases that aligned to the autosomal loci in {} divided by the total number of loci in the autosomal loci in {}. If there is no autosomes in the reference genome, or the region does not intersect autosomes, this metric shows as NA.'),
    ...
    Metric('Mean/Median autosomal coverage ratio over {}'   , 'Mean/med aut cov', 'hid', 'hid', ''     , 'Mean autosomal coverage in {} divided by the median autosomal coverage in {}. If there is no autosome in the reference genome or the region does not intersect autosomes, this metric shows as NA.', precision=2),
    Metric('PCT of genome with coverage [  1x: inf)'        , '⩾1x'             , 'hid', '#'  , '%'    , 'Percentage of sites in region with at least 1x coverage.'),
    Metric('PCT of genome with coverage [  3x: inf)'        , '⩾3x'             , None , 'hid', '%'    , 'Percentage of sites in region with at least 3x coverage.'),
    Metric('PCT of genome with coverage [ 10x: inf)'        , '⩾10x'            , None , '#'  , '%'    , 'Percentage of sites in region with at least 10x coverage.'),
    Metric('PCT of genome with coverage [ 15x: inf)'        , '⩾15x'            , None , 'hid', '%'    , 'Percentage of sites in region with at least 15x coverage.'),
    ...
    Metric('PCT of genome with coverage [100x: inf)'        , '⩾100x'           , 'hid', '#'  , '%'    , 'Percentage of sites in region with at least 100x coverage.'),
    Metric('PCT of genome with coverage [  0x:  1x)'        , '0x'              , None , 'hid', '%'    , 'Percentage of sites in region with no coverage.'),
    Metric('PCT of genome with coverage [  1x:  3x)'        , '1x..3x'          , None , 'hid', '%'    , 'Percentage of sites in region with at least 1x but less than 3x coverage.'),
    Metric('PCT of genome with coverage [  3x: 10x)'        , '3x..10x'         , None , 'hid', '%'    , 'Percentage of sites in region with at least 3x but less than 10x coverage.'),
    Metric('PCT of genome with coverage [ 10x: 15x)'        , '10x..15x'        , None , 'hid', '%'    , 'Percentage of sites in region with at least 10x but less than 15x coverage.'),
    Metric('PCT of genome with coverage [ 15x: 20x)'        , '15x..20x'        , None , 'hid', '%'    , 'Percentage of sites in region with at least 15x but less than 20x coverage.'),

...
COV_METRICS = list(flatten([[
    ...
    # Read stats:
    ('Aligned bases'                                      , 'Aln bases'          ,'bases' , 'hid', '#'  , 'Total number of aligned bases.'),
    ...
    ('Aligned reads'                                      , 'Aln reads'          ,'reads' , 'hid', '#'  , 'Total number of aligned reads.'),
    ...
    ('PCT of genome with coverage [100x: inf)'            , '%>=100x'            ,'%'     , 'hid', 'hid', 'Percentage of sites in region with at least 100x coverage.'),
    ...
    ('PCT of genome with coverage [ 15x: inf)'            , '%>=15x'             ,'%'     , 'hid', 'hid', 'Percentage of sites in region with at least 15x coverage.'),
    ('PCT of genome with coverage [ 10x: inf)'            , '%>=10x'             ,'%'     , 'hid', '#'  , 'Percentage of sites in region with at least 10x coverage.'),
    ('PCT of genome with coverage [  3x: inf)'            , '%>=3x'              ,'%'     , 'hid', 'hid', 'Percentage of sites in region with at least 3x coverage.'),
    ('PCT of genome with coverage [  1x: inf)'            , '%>=1x'              ,'%'     , 'hid', 'hid', 'Percentage of sites in region with at least 1x coverage.'),
    ...
    ('PCT of genome with coverage [ 20x: 50x)'            , '% 20x..50x'         ,'%'     , 'hid', 'hid', 'Percentage of sites in region with at least 20x but less than 50x coverage.'),

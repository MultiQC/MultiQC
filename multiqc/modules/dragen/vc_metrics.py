...
VC_METRICS = [Metric(m.id, m.title, in_genstats=m.in_genstats, in_own_tabl=m.in_own_tabl, descr=m.descr, unit=m.unit,
    ...
    Metric('Biallelic', 'Biallelic', None, 'hid', '',
    ...
    Metric('Multiallelic', 'Multiallelic', 'hid', '%', '',
    ...
    Metric('Insertions (Het)', 'Het ins', None, 'hid', '',
    ...
    Metric('DeNovo INDELs', 'DeNovo indel', None, None, '',
    ...
    Metric('DeNovo MNPs', 'DeNovo MNPs', None, None, '',
    ...
    Metric('(Chr X SNPs)/(chr Y SNPs) ratio over genome', 'X/Y SNP ratio', None, 'hid', '', 'Number of SNPs in chromosome X (or in the intersection of chromosome X with the target region) '
           ...
           '', 'shows as NA'),
    Metric('SNP Transitions', 'SNP Ti', None, None, '',
           'Number of transitions - interchanges of two purines (A<->G) or two pyrimidines (C<->T)'),
    Metric('SNP Transversions', 'SNP Tv', None, None, '',
    ...
    Metric('Filtered vars', 'Filt var', 'hid', 'hid', '',
           'Number of raw variants minus the number of PASSed variants', the_higher_the_worse=True),
    Metric('Filtered SNPs', 'Filt SNP', 'hid', '%', '',
           'Number of raw SNPs minus the number of PASSed SNPs', the_higher_the_worse=True),
    Metric('Filtered indels', 'Filt indel', 'hid', '%', '',
           'Number of raw indels minus the number of PASSed indels', the_higher_the_worse=True),
    Metric('Reads Processed', 'VC reads', None, '#', 'reads',

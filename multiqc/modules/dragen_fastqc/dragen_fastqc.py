...
class MultiqcModule(DragenBaseMetrics, DragenReadMetrics, DragenFastqcGcMetrics, DragenContentMetrics):
    """
    Illumina DRAGEN is a Bio-IT Platform that provides ultra-rapid primary and secondary analysis of sequencing data
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(
            ...
            info="Illumina Bio-IT Platform that uses FPGA for accelerated primary and secondary analysis",

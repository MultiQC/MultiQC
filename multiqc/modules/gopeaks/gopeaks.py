...
class MultiqcModule(BaseMultiqcModule):
    """
    Calls peaks from aligned CUT&TAG sequencing reads. Gopeaks uses a binomial distribution to model the read counts
    in sliding windows across the genome and calculate peak regions that are enriched over the background.

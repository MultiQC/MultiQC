...
class MultiqcModule(BaseMultiqcModule):
    ...
    def nanoq_general_stats(self) -> None:
        ...
        headers = {
            ...
            "N50 read length": {"title": "Read N50", "description": "N50 read length", "scale": "Blues"},
            "Longest read": {"title": "Longest Read", "description": "Longest read length (bp)", "scale": "Oranges"},
            "Shortest read": {"title": "Shortest Read", "description": "Shortest read length (bp)", "scale": "YlOrRd"},
            "Mean read length": {"title": "Mean Length", "description": "Mean read length (bp)", "scale": "PuBuGn"},
            "Median read length": {
                "title": "Median Length",

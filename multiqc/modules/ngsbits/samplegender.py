...
class MultiqcModule(BaseMultiqcModule):
    ...
    def parse_reports(self):
        ...
        # Add SampleGender Table section
        self.add_section(
            name="Sample Gender", anchor="ngsbits-samplegender", plot=samplegender_table(self.samplegender_data)
        )

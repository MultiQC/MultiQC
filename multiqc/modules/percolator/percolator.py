...
GROUP_TO_FEATURE = config.custom_data.get("percolator", {}).get("group_to_feature", {})
...
class MultiqcModule(BaseMultiqcModule):
    ...
    The module accepts one configuration option:
     - `group_to_feature`: A dictionary mapping group names to feature names (empty per default).
     Add this option to `multiqc_config.yaml` under custom_data/percolator.
    """
    ...
    def __init__(self):
        ...
        barplot_data = {
            feature: {f"{FEATURE_TO_GROUP.get(feature, 'other')}": median_value}

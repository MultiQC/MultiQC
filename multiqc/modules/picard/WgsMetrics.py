...
def parse_reports(self):
    ...
    for f in self.find_log_files("picard/wgs_metrics", filehandles=True):
        ...
        for line in f["f"]:
            ...
            # New log starting
            if "WgsMetrics" in line and "INPUT" in line:
                s_name = None
            ...
            if s_name is not None:
                ...
                if any(n in line for n in metric_names) and "## METRICS CLASS" in line:
                    ...
                    self.picard_wgsmetrics_histogram[s_name] = {}
                    in_hist = True
    ...
    keys = {
        "PCT_EXC_MAPQ": {"name": "Low mapping quality"},
        "PCT_EXC_DUPE": {"name": "Duplicates reads"},
        "PCT_EXC_UNPAIRED": {"name": "No mapped mate pair"},
        "PCT_EXC_BASEQ": {"name": "Low base quality"},
        "PCT_EXC_OVERLAP": {"name": "Overlapping insert"},
        "PCT_EXC_CAPPED": {"name": "Over capped coverage"},
    }

...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(
            ...
            info="Estimates the complexity of a library, showing how many additional unique reads are sequenced for increasing total read count.",
            extra="A shallow curve indicates complexity saturation. The dashed line shows a perfectly complex library where total reads = unique reads.",

...
class MultiqcModule(BaseMultiqcModule):
    """
    The Samtools module parses results generated by Samtools a suite of programs for interacting with
    ...
    def __init__(self):
        ...
        super(MultiqcModule, self).__init__(
            ...
            info="Suite of programs for interacting with high-throughput sequencing data.",

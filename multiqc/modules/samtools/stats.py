...
def alignment_section(module, samples_data):
    bedgraph_data = {}
    for sample_id, data in samples_data.items():
        ...
        read_sum = data["reads_mapped_MQ1"] + data["reads_MQ0"] + data["reads_unmapped"] + data["filtered_sequences"]

...
class MultiqcModule(BaseMultiqcModule):
    ...
    def parse_logs(f):
        ...
        if "# output generated by dedup" not in f["f"] and "# output generated by extract" not in f["f"]:
            log.debug(f"Skipping as not a dedup or extract log: {f['fn']}")
            return None, None
        ...
        for type_, key, regex in dedup_regexes + extract_regexes:
    ...
    def umitools_umi_stats_swarm(self):
        ...
        headers = {
            ...
            "read1_match": {
                "title": "Read1 Match",
                "description": "Read1 matched regex",
                "min": 0,
                "format": "{:,d}",
                "scale": "Blues",
            },
            "read2_match": {
                "title": "Read2 Match",
                "description": "Read2 matched regex",
                "min": 0,
                "format": "{:,d}",
                "scale": "Blues",
            },
            "read1_mismatch": {
                "title": "Read1 Mismatch",
                "description": "Read1 did not match regex",
                "min": 0,
                "format": "{:,d}",
                "scale": "Reds",
            },
            "read2_mismatch": {
                "title": "Read2 Mismatch",
                "description": "Read2 did not match regex",
                "min": 0,
                "format": "{:,d}",
                "scale": "Reds",
            },

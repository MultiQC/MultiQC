...
$(document).ready(function () {
  ...
  // $(".ai-summary-expand").on("click", function (e) {
  //   // find parent .ai-summary element
  //   const $aiSummary = $(this).closest(".ai-summary");
  //   const $details = $aiSummary.find("details");
  ...
  $(".btn-ai-generate-summary").click(async function (e) {
    ...
    let token = el.data("seqera-ai-token");
    ...
    let summary = `<div style="display: flex; justify-content: space-between; align-items: center">
        <b>Seqera AI Summary ${betaIcon}</b>

...
fn_clean_exts = ['.gz', '.fastq', '.fq', '.bam', '.sam', '.sra', '_tophat', 'Log.final.out', '_star_aligned', '_fastqc', '.hicup', '.counts', '_counts', '.txt', 'Aligned', '.vcf']
...
module_order = [
    ...
    'picard', 'preseq', 'samblaster', 'samtools', 'bamtools', 'gatk'

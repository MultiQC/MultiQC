...
def test_mosdepth_thresholds_bed_parse_error_includes_filename(tmp_path):
...
def test_mosdepth_regions_bed_without_thresholds_skips_per_region_section(tmp_path):
